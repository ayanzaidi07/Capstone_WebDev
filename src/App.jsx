...
const PRODUCTS = [
  { id: 1,  name: "Football",      cat: "Sports",  price: 28,  emoji: "⚽️", rating: 4.8, reviews: 124, badge: "new"  },
  { id: 2,  name: "Frame with picture",   cat: "Decor",  price: 45,  oldPrice: 60,  emoji: "🖼️", rating: 4.6, reviews: 89,  badge: "sale" },
  { id: 3,  name: "Baseball",    cat: "Sports",  price: 75,  emoji: "⚾️", rating: 4.9, reviews: 203 },
  { id: 4,  name: "Basket",     cat: "Furniture",  price: 32,  emoji: "🧺", rating: 4.5, reviews: 67  },
  { id: 5,  name: "Hockey",     cat: "Sports", price: 38,  emoji: "🏒", rating: 4.7, reviews: 55,  badge: "new"  },
  { id: 6,  name: "Chair",         cat: "Furniture", price: 120, oldPrice: 150, emoji: "🪑", rating: 4.9, reviews: 311, badge: "sale" },
  { id: 7,  name: "Table Tennis",      cat: "Sports",    price: 55,  emoji: "🏓", rating: 4.4, reviews: 42  },
  { id: 8,  name: "Volleyball",      cat: "Sports", price: 88,  emoji: "🏐", rating: 4.8, reviews: 178, badge: "new"  },
  { id: 9,  name: "Socks",   cat: "Clothes", price: 145, oldPrice: 180, emoji: "🧦", rating: 4.7, reviews: 92,  badge: "sale" },
  { id: 10, name: "Shirt and tie",       cat: "Clothes",    price: 62,  emoji: "👔", rating: 4.6, reviews: 136 },
...
const CATEGORIES = ["All", "Sports", "Clothes", "Decor", "Furniture", "Tech", "Sale"];
...
function Stars({ rating }) {
  return (
    <span>
      {[1, 2, 3, 4, 5].map((i) => (
        <span key={i} style={{ color: i <= Math.round(rating) ? "#d38ad1ff" : "#ddd", fontSize: 11 }}>★</span>
      ))}
    </span>
  );
}
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "20px", borderBottom: "0.5px solid #e5e5e5" }}>
          <h2 style={{ fontFamily: "'Segoe UI', sans-serif", fontSize: 20 }}>Cart</h2>
          <button onClick={onClose} style={{ background: "none", border: "none", fontSize: 18, cursor: "pointer", color: "#6f716fff" }}>✕</button>
        </div>
        ...
        {items.length > 0 && (
          <div style={{ padding: 20, borderTop: "0.5px solid #e5e5e5" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", fontSize: 13, color: "#888", marginBottom: 14 }}>
              <span>Shipping</span><span style={{ color: "#449866ff" }}>Free</span>
            </div>
            <div style={{ display: "flex", justifyContent: "space-between", fontSize: 16, fontWeight: 500, marginBottom: 16 }}>
              <span>Total</span><span>${total}</span>
            </div>
            <button style={{
              width: "100%", padding: 13, background: "#39598dff", color: "#fff",
      ...
      <div style={{ height: 140, background: "#f8f7f4", display: "flex", alignItems: "center", justifyContent: "center", position: "relative" }}>
        ...
        {product.badge && (
          <span style={{
            ...
            color: product.badge === "sale" ? "#4e291dff" : "#27aa8aff",
          }}>
      ...
      <div style={{ padding: 12 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <button
            ...
            style={{
              width: 28, height: 28,
              background: inCart ? "#0F6E56" : "#1e4e88ff",
    ...
    <>
      ...
      <div style={{ fontFamily: "'DM Sans', sans-serif", minHeight: "100vh", background: "#fefefe", color: "#111" }}>
        ...
        <nav style={{
          ...
          <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 22, letterSpacing: "-0.5px", cursor: "pointer" }}>
            Velvora<span style={{ color: "#1a3753ff" }}>è</span>re
          </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            ...
            >
              ...
              <span>Cart</span>
              <span style={{
                background: "#1e4e88ff", color: "#fff", fontSize: 10, fontWeight: 500,
        ...
        <section style={{
          ...
          <div>
            <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 42, lineHeight: 1.15, marginBottom: 14 }}>
              Curated <span style={{ color: "#1e4e88ff" }}>Modern</span><br />Lifestyle Goods
            </h1>
            ...
            <div style={{ display: "flex", gap: 12 }}>
              <button
                ...
                style={{ padding: "10px 24px", background: "#1e4e88ff", color: "#fff", border: "none", borderRadius: 8, fontSize: 13, cursor: "pointer", fontFamily: "'DM Sans', sans-serif" }}
              >
                Browse All
              </button>
              <button
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            {featuredHero.map((p) => (
              ...
              >
                ...
                <div style={{ fontSize: 13, color: "#1e4e88ff", fontWeight: 500 }}>${p.price}</div>
              </div>
            ))}
          </div>
        </section>
          ...
          {CATEGORIES.map((cat) => (
            <button
              ...
              style={{
                ...
                background: category === cat ? "#1e4e88ff" : "transparent",
                color: category === cat ? "#fff" : "#444",
                borderColor: category === cat ? "#1e4e88ff" : "#e5e5e5",
                transition: "all 0.2s",
              }}
            >
              {cat}
